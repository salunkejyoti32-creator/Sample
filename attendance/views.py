...
from .utils import ensure_django_request
...
def login_user_new(request):
    ...
    # If you need to call a Django API that requires a django.http.HttpRequest,
    # unwrap the DRF Request like this:
    # django_request = ensure_django_request(request)
